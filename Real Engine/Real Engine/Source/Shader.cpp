...
//}
//
//void Shader::SetMat4(const std::string& name, float* mat4) const
//{
//    glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, &*mat4);
//}
//
//void Shader::SetShaderUniform(GLuint shaderProgram, const char* uniformName, float value)
//{
...
//}
//
//std::unordered_map<std::string, float> Shader::GetShaderUniforms(GLuint shaderProgram)
//{
